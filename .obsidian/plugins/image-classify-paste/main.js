  ...
  addPastePathSetting() {
    new import_obsidian2.Setting(this.containerEl).setName("Select Image Save Path").setDesc(
      ...
      dropdown.setValue(this.plugin.settings.PasteImageOption).onChange((value) => {
        ...
        if (value == "tocustom") {
          if (value != "tocustom")
            this.plugin.settings.CustomPath = "";
        }
      });
    });
  }
  ...
  async getRenameFilePath(mdFile, filename) {
    ...
    switch (this.settings.PasteImageOption) {
      case "current":
        ...
        break;
      case "toassets":
        dirPath = ((_a = mdFile.parent) == null ? void 0 : _a.path) ? path.join(mdFile.parent.path, ".assets") : mdFile.basename;
        break;
      ...
      case "tocustom":
        ...
        if (this.settings.CustomPath.startsWith("./")) {
          dirPath = ((_c = mdFile.parent) == null ? void 0 : _c.path) ? path.join(mdFile.parent.path, replacePath) : replacePath;
        } else {
          dirPath = replacePath;
        }
        break;
      default:
        dirPath = ((_d = mdFile.parent) == null ? void 0 : _d.path) ? path.join(mdFile.parent.path, mdFile.basename) : mdFile.basename;
    }
    console.log((_e = mdFile.parent) == null ? void 0 : _e.path, mdFile.basename, dirPath);
