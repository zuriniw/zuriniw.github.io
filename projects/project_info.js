...
const projects = [
    new Project({
        ...
        labels: ["XR", "Human-Centered", "Physical/Spatial"],
        time: "2024",
        ispage: true,
        isteam: true,
        tutor: "Chao Yan",
    ...
    new Project({
        ...
        labels: ["Human-Centered","Physical/Spatial"],
        time: "2024",
        ispage: true,
        isteam: true,
        ismarkdown: true,
    ...
    //     labels: ["Physical/Spatial", "Digital"],
    //     time: "2022",
...
const availableLabels = [
    "Digital", "Physical/Spatial", "XR", "Human-Centered"
];
